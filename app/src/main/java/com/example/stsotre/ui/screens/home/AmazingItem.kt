...
fun AmazingItem(item :AmazingItem){
    ...
    Card( modifier = Modifier.padding(vertical = MaterialTheme.spacing.semilarge,
        ...
        Column (modifier = Modifier
            ...
            Column (modifier = Modifier
                ...
                Text(text = stringResource(id = R.string.amazing_for_app),
                    modifier = Modifier
                ...
                Image(painter = rememberAsyncImagePainter(item.image), contentDescription = "",
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(130.dp),
            ...
            Column(modifier = Modifier
                ...
                Row (modifier = Modifier.fillMaxWidth(),
                    ...
                    Icon(painter = painterResource(id = R.drawable.in_stock), contentDescription ="",
                ...
                Row (modifier = Modifier
                    ...
                    Box (modifier = Modifier
                        ...
                        Text(text = "${digitByLocate(item.discountPercent.toString())}",
                            color = Color.White,
                            style = MaterialTheme.typography.h6,
                            fontWeight = FontWeight.SemiBold)
                    }
                    ...
                    Column {
                        Row {
                            Text(text = digitByLocateAndSeparator(applyDiscount(item.price, item.discountPercent).toString())
                                , style = MaterialTheme.typography.body2,
                                fontWeight = FontWeight.SemiBold,
                            )

                            Image(painter = painterResource(id = R.drawable.toman), contentDescription = ""
